...
Простейший baseline, сделанный за пару часов + пару ночей grid search позволили выйти в лидеры, а две недели экспериментов со иерархическим классификатором сложной структуры не увенчались никаким успехом, кроме полученного опыта о том, что простым задачам - простые решения.
